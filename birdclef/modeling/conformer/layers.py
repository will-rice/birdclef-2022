...
class SubsamplingConv1D(keras.layers.Layer):
...
class DepthwiseConv1D(keras.layers.Layer):
...
class ConvolutionBlock(keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.conv_1 = keras.layers.Conv1D(
            filters=2 * filters, kernel_size=1, padding="valid"
        )
...
class TFPositionwiseFF(keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.fc_1 = keras.layers.Dense(d_inner)
        self.activation = keras.layers.Activation("swish")
        self.dropout_1 = keras.layers.Dropout(dropout)

        self.fc_2 = keras.layers.Dense(d_model)
...
class RelativeMultiHeadAttention(keras.layers.Layer):
    ...
    def __init__(
        ...
        self.query_proj = keras.layers.Dense(d_model)
        self.key_proj = keras.layers.Dense(d_model)
        self.value_proj = keras.layers.Dense(d_model)
        self.pos_proj = keras.layers.Dense(d_model, use_bias=False)
...
class MultiHeadedSelfAttention(keras.layers.Layer):
    """MHSA."""
...
class ConformerEncoder(keras.layers.Layer):
    """Conformer Encoder."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.linear_proj = keras.layers.Dense(units)
        self.dropout = keras.layers.Dropout(encoder_dropout)
        self._layers = [
            ConformerBlock(
                d_model=units,
                num_attention_heads=num_attention_heads,
